        ...
        o = {
            ...
            confirm: function() {
                if (a.range) {
                    ...
                    if(a.timeLimits){
                    if (((n.endDate.month+12*(n.endDate.year - n.startDate.year)) - n.startDate.month) > 3) return n.hint("日期范围限制三个月内");
                    }
